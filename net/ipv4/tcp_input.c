...
/* the following are needed by the dlkm but they're no longer supported in the stack
 * so I need to figure out a way to get them into the dlkm posty hasty -cjr
